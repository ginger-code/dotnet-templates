...
public class EmailModel : PageModel
{
    ...
    public EmailModel( UserManager< GingerCodeSiteUser > userManager , SignInManager< GingerCodeSiteUser > signInManager , IEmailSender emailSender )
    {
    ...
    private async Task LoadAsync( GingerCodeSiteUser user )
    {
