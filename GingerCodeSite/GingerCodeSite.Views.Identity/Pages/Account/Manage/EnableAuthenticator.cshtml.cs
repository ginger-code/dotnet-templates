...
public class EnableAuthenticatorModel : PageModel
{
    ...
    public EnableAuthenticatorModel( UserManager< GingerCodeSiteUser > userManager , ILogger< EnableAuthenticatorModel > logger , UrlEncoder urlEncoder )
    {
    ...
    public async Task< IActionResult > OnPostAsync()
    {
        ...
        if ( await _userManager.CountRecoveryCodesAsync( user ) == 0 )
        {
            ...
            return RedirectToPage( "./recovery-codes" );
        }

        return RedirectToPage( "./two-factor" );
    }

    private async Task LoadSharedKeyAndQrCodeUriAsync( GingerCodeSiteUser user )
    {
